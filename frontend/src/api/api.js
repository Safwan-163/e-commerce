...
export const getProductToUpdate = async (productCode) => {
  const response = await API.get(
    `products/product-to-update/${productCode}/`
  );
...
export const addToCart = async (productCode, quantity = 1) => {
